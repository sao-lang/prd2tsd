...
> ⚠️ **原始设计文档**：本文档是项目的原始 PRD 设计稿，记录初始设计意图和全量功能规划。
> 当前实现状态以 `overview.md` 和代码为准。**不要直接修改本文档**——如有设计变更，在 `docs/` 或 `overview.md` 中记录，并引用本文档对应章节。
...
class DocumentPreviewService:
    ...
    │ .png/.jpg│ Pillow 校验 → Gateway Vision OCR 文字与语义提取     │
    │ .txt     │ 前2000字预览                                         │
    └──────────┴──────────────────────────────────────────────────────┘
    """
