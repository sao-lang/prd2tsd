...
class Settings(BaseSettings):
    ...
    KNOWLEDGE_OCR_MAX_IMAGES: int = 50
    KNOWLEDGE_OCR_MAX_IMAGE_BYTES: int = 20 * 1024 * 1024
    KNOWLEDGE_OCR_MAX_TOTAL_IMAGE_BYTES: int = 50 * 1024 * 1024
    KNOWLEDGE_OCR_ESTIMATED_TOKENS_PER_IMAGE: int = 4096
